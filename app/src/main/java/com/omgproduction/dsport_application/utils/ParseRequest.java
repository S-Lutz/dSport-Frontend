...
import com.omgproduction.dsport_application.error.ErrorResponse;
import com.omgproduction.dsport_application.listeners.callbacks.BackendCallback;

import java.io.UnsupportedEncodingException;
import java.util.Map;

public class ParseRequest<T> extends Request<T> {
    ...
    public ParseRequest(String url, int method, Class<T> clazz, Object body,Map<String, String> headers, final BackendCallback<T> listener) {
