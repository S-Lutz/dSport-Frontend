package com.omgproduction.dsport_application.refactored.config;
...
public interface ApplicationConfig {
    ...
    String APPLICATION_CONFIG_DATE_FORMAT ="yyyy-MM-dd HH:mm:ss.SSS";
    ...
    String API_KEY = "AIzaSyAHcO3HcjndPyb3PnJIUQmgMmbfsVNIzZc";
