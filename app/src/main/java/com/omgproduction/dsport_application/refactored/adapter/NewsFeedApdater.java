...
import com.omgproduction.dsport_application.refactored.adapter.viewholder.EventViewHolder;
import com.omgproduction.dsport_application.refactored.adapter.viewholder.ExerciseViewHolder;
import com.omgproduction.dsport_application.refactored.adapter.viewholder.PostViewHolder;
...
public class NewsFeedApdater extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public NewsFeedApdater(Context context, ArrayList<SocialResultPair> socialNodes, onSocialItemClickedListener itemClickListener) {
    ...
    private void configureEventViewHolder(EventViewHolder eventViewHolder, int position) {
        ...
        eventViewHolder.getEventProfileheaderSubText().setText(currentEvent.getCreated());
    ...
    private void configurePostViewHolder(PostViewHolder postViewHolder, int position) {
        ...
        postViewHolder.getPostProfileheaderSubText().setText(currentPost.getCreated());
