...
import com.omgproduction.dsport_application.aaRefactored.adapter.viewholder.CommentViewHolder;
...
public class CommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        commentViewHolder.getCommentCreated().setText(DateConverter.convertDate(commentNode.getCreated()));
