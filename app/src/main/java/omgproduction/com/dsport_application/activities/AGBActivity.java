...
import omgproduction.com.dsport_application.controller.ResourceController;
import omgproduction.com.dsport_application.controller.SharedPreferencesController;
...
public class AGBActivity extends BasicActivity{
    ...
    private void onAGBAccepted() {
        new SharedPreferencesController(this)
                .putString(SharedPreferencesController.KEY_AGBVERSION,agb_version)
                .commit();

        ResourceController resourceController = ResourceController.getInstance();
        resourceController.putAGBVersion(
                new SharedPreferencesController(this)
                        .getStringDetail(SharedPreferencesController.KEY_USERID, "0"),
                agb_version,
